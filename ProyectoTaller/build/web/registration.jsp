...
<html>
	...
	<div class="container d-flex justify-content-center margin-top">
		<div class="mt-5">
			...
			<form class ="text-center" action="RegisterServlet" method="post">
				<p>Usuario</p>
				<input class="mb-2"type="text" type="text" placeholder="Usuario" name="name" required>
				<p>Email</p>
				<input class="mb-2" type="text" placeholder="Email" name="email" required>
				<p>Contraseña</p>
				<input type="password" placeholder="Contraseña" name="password"
					required> 
                                <br/>
                                <input class="mt-3 col-sm-2 btn btn-secondary text-center mb-2" type="submit" value="Registrar"> 
                                <br/>
                                <a class="mt-5 col-sm-2 text-muted" href="index.jsp">¿Ya tienes una cuenta?</a>
			</form>
		</div>
	</div>
    </body>
